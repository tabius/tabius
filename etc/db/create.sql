...
# Review queue for replacing broken YouTube links. One row per (song, broken video id). A background
# worker searches YouTube and fills `candidates`; a moderator approves a replacement via the admin UI.
